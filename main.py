...
bot_token = environ.get("TOKEN", "6338089128:AAEEaqfshglYA-fGAzF5nLA0_YYLzdejCSU") 
api_hash = environ.get("HASH", "0ef9fdd3e5f1ed49d4eb918a07b8e5d6") 
api_id = int(environ.get("ID", "26847865"))
